...
import type { AddPartnerProps } from '../types'
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="email" value={formData.officialEmail} onChange={(e) => handleInputChange('officialEmail', e.target.value)}
                    className={inputCls} placeholder="business@company.com" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="tel" value={formData.phone} onChange={(e) => handleInputChange('phone', e.target.value)}
                    className={inputCls} placeholder="+911145678900" />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.address} onChange={(e) => handleInputChange('address', e.target.value)}
                    className={inputCls} placeholder="123 Business Park" />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="text" value={formData.state} onChange={(e) => handleInputChange('state', e.target.value)}
                    className={inputCls} placeholder="Delhi" />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.city} onChange={(e) => handleInputChange('city', e.target.value)}
                    className={inputCls} placeholder="New Delhi" />
                </div>
                <div>
                  ...
                  <input type="text" value={formData.pinCode} onChange={(e) => handleInputChange('pinCode', e.target.value)}
                    className={inputCls} placeholder="110001" />
                </div>
              </div>
              <div>
                ...
                <input type="url" value={formData.website} onChange={(e) => handleInputChange('website', e.target.value)}
                  className={inputCls} placeholder="www.company.com" />
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="divide-y divide-slate-200 dark:divide-slate-700 border border-slate-200 dark:border-slate-700 rounded-lg">
                <div className="flex items-center justify-between px-4 py-4">
                  ...
                  <input type="text" value={formData.accountHolder} onChange={(e) => handleInputChange('accountHolder', e.target.value)}
                ...
                <div className="flex items-center justify-between px-4 py-4">
                  ...
                  <select value={formData.bankName} onChange={(e) => handleInputChange('bankName', e.target.value)}
                ...
                <div className="flex items-center justify-between px-4 py-4">
                  ...
                  <input type="text" value={formData.ifscCode} onChange={(e) => handleInputChange('ifscCode', e.target.value.toUpperCase())}
