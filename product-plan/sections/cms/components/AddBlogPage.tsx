...
export function AddBlogPage({ onSubmit, onCancel }: AddBlogPageProps) {
    ...
    <div className="min-h-[calc(100vh-64px)] bg-slate-50 dark:bg-slate-950">
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-8 py-5">
        <div className="flex items-center gap-4 max-w-4xl">
          ...
          <h1 className="text-xl font-bold text-slate-900 dark:text-white">Add Blog</h1>
        </div>
      </div>
                ...
                <div className="flex items-end pb-2">
                  <label className="flex items-center gap-2.5 cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        setForm({ ...form, featuredOnChallanPay: e.target.checked })
                      }
