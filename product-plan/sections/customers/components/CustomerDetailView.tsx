...
import type { Customer, Vehicle, Incident, Challan, ActivityLog } from '../types'
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                              ...
                              challan.paymentStatus === 'refunded' ? 'bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400' :
