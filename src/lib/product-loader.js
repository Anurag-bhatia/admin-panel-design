 ...
 * [One sentence description]
 */
export function parseProductRoadmap(md) {
    if (!md || !md.trim())
        return null;
    try {
        const sections = [];
