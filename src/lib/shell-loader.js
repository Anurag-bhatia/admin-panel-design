 ...
 */
export function hasShellComponents() {
 ...
 */
export function loadShellComponent(componentName) {
...
export function loadAppShell() {
    ...
    if (wrapperPath in shellComponentModules) {
        return shellComponentModules[wrapperPath];
    }
