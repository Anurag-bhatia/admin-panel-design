 ...
 */
function extractSectionIdFromProduct(path) {
 ...
 */
function extractSectionIdFromSrc(path) {
 ...
 */
function extractScreenDesignName(path) {
 ...
 */
function extractScreenshotName(path) {
 ...
 */
export function getSectionScreenDesigns(sectionId) {
    const screenDesigns = [];
 ...
 */
export function getSectionScreenshots(sectionId) {
    const screenshots = [];
 ...
 */
export function loadScreenDesignComponent(sectionId, screenDesignName) {
 ...
 */
export function hasSectionSpec(sectionId) {
 ...
 */
export function sectionUsesShell(sectionId) {
    const specPath = `/product/sections/${sectionId}/spec.md`;
    const specContent = specFiles[specPath];
    if (!specContent)
        return true; // Default to using shell if no spec
 ...
 */
export function hasSectionData(sectionId) {
