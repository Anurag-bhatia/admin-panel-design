...
function Row({ index, config, onEdit, onHistory, }) {
    ...
    return (_jsxs("tr", { className: "group hover:bg-slate-50/60 dark:hover:bg-slate-800/30 transition-colors", children: [_jsx("td", { className: "py-3 pl-5 pr-3 text-[13px] tabular-nums text-slate-500 dark:text-slate-400", children: index }), _jsx("td", { className: "py-3 px-3", children: _jsx("button", { type: "button", onClick: onEdit, className: "font-medium text-slate-900 dark:text-white hover:text-cyan-700 dark:hover:text-cyan-400 transition-colors text-left", children: config.state }) }), _jsx("td", { className: "py-3 px-3 text-slate-500 dark:text-slate-400 text-[13px]", children: config.region }), _jsx(AmountCell, { value: onlineAmount }), _jsx(AmountCell, { value: courtAmount }), _jsx("td", { className: "py-3 px-3", children: _jsx("span", { className: `inline-flex items-center px-2 py-0.5 rounded text-[11px] font-semibold uppercase tracking-wider ${isExpress
                        ? 'bg-amber-50 text-amber-800 dark:bg-amber-900/25 dark:text-amber-300'
                        : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400'}`, children: isExpress ? 'Express' : 'Regular' }) }), _jsx("td", { className: "py-3 px-3", children: _jsxs("div", { className: "flex flex-col leading-tight", children: [_jsx("span", { className: "text-[13px] text-slate-800 dark:text-slate-200 font-medium", children: config.lastUpdatedBy }), _jsx("span", { className: "text-[11px] text-slate-500 dark:text-slate-400", children: formatRelative(config.lastUpdatedAt) })] }) }), _jsx("td", { className: "py-3 px-3 w-px whitespace-nowrap", children: _jsx(StatusBadge, { status: config.status }) }), _jsx("td", { className: "py-3 pr-5 pl-3 w-px whitespace-nowrap", children: _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(ActionButton, { icon: _jsx(Pencil, { className: "w-3.5 h-3.5" }), label: "Edit", onClick: onEdit, primary: true }), _jsx(ActionButton, { icon: _jsx(History, { className: "w-3.5 h-3.5" }), label: "History", onClick: onHistory })] }) })] }));
}
function AmountCell({ value }) {
    return (_jsx("td", { className: "py-3 px-3 text-right", children: _jsxs("span", { className: "inline-block px-2 py-0.5 rounded tabular-nums text-[13px] font-medium bg-cyan-50 text-cyan-800 dark:bg-cyan-900/25 dark:text-cyan-300", children: ["\u20B9", value.toLocaleString('en-IN')] }) }));
}
