                ...
                <div className="space-y-2">
                  {products.map((product) => (
                    <label key={product} className="flex items-center gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded cursor-pointer">
                      <input type="checkbox" checked={formData.productsAllowed.includes(product)}
                ...
                <div className="space-y-2">
                  {subscriberTypes.map((type) => (
                    <label key={type} className="flex items-center gap-3 p-2 hover:bg-slate-50 dark:hover:bg-slate-800 rounded cursor-pointer">
                      <input type="checkbox" checked={formData.subscriberTypesAllowed.includes(type)}
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={formData.bankName} onChange={(e) => handleInputChange('bankName', e.target.value)} className={selectCls}>
                ...
                <div>
                  ...
                  <input type="text" value={formData.bankAccountNumber}
                    ...
                    className={`${inputCls} font-mono`} placeholder="0123456789012345" />
                </div>
              </div>
