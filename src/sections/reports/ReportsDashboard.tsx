...
export default function ReportsDashboardPreview() {
  return (
    <ReportsDashboard
      ...
      leadsReport={data.leadsReport}
      subscribersReport={data.subscribersReport}
      lawyersReport={data.lawyersReport}
      partnersReport={data.partnersReport}
      paymentsReport={data.paymentsReport}
      disputesReport={data.disputesReport}
      supportReport={data.supportReport}
