...
export function SubscriberList({ subscribers, subscriptions, users, partners, subscriberSources, subscriberTypes, subscriberSubTypes, planTypes, onViewDetails, onEdit, onAddSubscriber, onBulkUpload, onSearch, onFilter, utmSources = [], vehicleTypes = [], userTypes = [], onViewSubscription, }) {
    ...
    const [subscriptionsModalSubscriberId, setSubscriptionsModalSubscriberId] = useState(null);
    ...
    const filteredSubscribers = useMemo(() => {
        return subscribers.filter((sub) => {
            ...
            if (locationFilter && !sub.state.toLowerCase().includes(locationFilter.toLowerCase()))
                return false;
            // Partner filter
            if (partnerFilter && sub.partnerId !== partnerFilter)
                return false;
            // UTM Source filter (matches against source field)
            if (utmSourceFilter && sub.source?.toLowerCase() !== utmSourceFilter.toLowerCase())
                return false;
            ...
            if (vehicleTypeFilter) {
                ...
                if (isCommercial && !['commercial', 'heavy', 'delivery', 'distribution', 'express', 'rental', 'refrigerated'].some(k => lotsFor.includes(k)))
                    return false;
                if (!isCommercial && !['private', 'personal', 'company fleet'].some(k => lotsFor.includes(k)))
                    return false;
            }
            // User type filter
            if (userTypeFilter) {
                if (userTypeFilter === 'Subscribers' && sub.status !== 'active')
                    return false;
                if (userTypeFilter === 'Visitors' && sub.status !== 'inactive')
                    return false;
            }
            return true;
        });
    ...
    return (_jsxs("div", { className: "min-h-screen bg-slate-50 dark:bg-slate-950", children: [_jsxs("div", { className: "max-w-[1600px] mx-auto p-4 sm:p-6 lg:p-8", children: [_jsx("div", { className: "mb-6", children: _jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6", children: [_jsx("div", { children: _jsx("h1", { className: "text-2xl font-semibold text-slate-900 dark:text-slate-100", children: "Subscribers" }) }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsxs("button", { onClick: () => setShowBulkUploadModal(true), className: "inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors shadow-sm", children: [_jsx(UploadIcon, {}), _jsx("span", { className: "hidden sm:inline", children: "Bulk Upload" })] }), _jsxs("button", { onClick: () => setShowAddModal(true), className: "inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-medium text-white bg-cyan-600 rounded-lg hover:bg-cyan-700 transition-colors shadow-sm", children: [_jsx(PlusIcon, {}), _jsx("span", { children: "Add Subscriber" })] })] })] }) }), _jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [_jsxs("div", { className: "flex-1 relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-slate-400" }), _jsx("input", { type: "text", placeholder: "Search by name, ID, GST, or contact...", value: searchQuery, onChange: (e) => {
                                            ...
                                            : 'bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800'}`, children: [_jsx(Filter, { className: "w-4 h-4 sm:w-5 sm:h-5" }), _jsx("span", { className: "hidden sm:inline", children: "Filters" })] })] }), showFilters && (_jsxs("div", { className: "mt-4 p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg", children: [_jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Status" }), _jsxs("select", { value: statusFilter, onChange: (e) => setStatusFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "All Status" }), _jsx("option", { value: "active", children: "Active" }), _jsx("option", { value: "inactive", children: "Inactive" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Source" }), _jsxs("select", { value: sourceFilter, onChange: (e) => setSourceFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "All Sources" }), subscriberSources.map((source) => (_jsx("option", { value: source, children: source }, source)))] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Location" }), _jsx("input", { type: "text", placeholder: "Filter by state...", value: locationFilter, onChange: (e) => setLocationFilter(e.target.value), className: "w-full px-3 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Plan Type" }), _jsxs("select", { value: planTypeFilter, onChange: (e) => setPlanTypeFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "All Plans" }), planTypes.map((plan) => (_jsx("option", { value: plan, children: plan }, plan)))] })] }), _jsxs("div", { ref: partnerDropdownRef, className: "relative", children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Partner" }), _jsxs("button", { type: "button", onClick: () => setShowPartnerDropdown(!showPartnerDropdown), className: "w-full flex items-center justify-between pl-3 pr-3 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-left focus:outline-none focus:ring-2 focus:ring-cyan-500", children: [_jsx("span", { className: partnerFilter ? 'text-slate-900 dark:text-white' : 'text-slate-400', children: partnerFilter ? partners.find(p => p.id === partnerFilter)?.name || 'Select' : 'Select' }), _jsx("svg", { className: "w-4 h-4 text-slate-400 flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("polyline", { points: "6 9 12 15 18 9", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" }) })] }), showPartnerDropdown && (_jsxs("div", { className: "absolute z-20 mt-1 w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg overflow-hidden", children: [_jsx("div", { className: "p-2 border-b border-slate-200 dark:border-slate-700", children: _jsx("input", { type: "text", value: partnerSearch, onChange: (e) => setPartnerSearch(e.target.value), placeholder: "Search partners...", className: "w-full px-2.5 py-1.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded text-xs sm:text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-cyan-500", autoFocus: true }) }), _jsxs("div", { className: "max-h-48 overflow-y-auto", children: [_jsx("button", { onClick: () => { setPartnerFilter(''); setPartnerSearch(''); setShowPartnerDropdown(false); }, className: `w-full text-left px-3 py-2.5 text-xs sm:text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors ${!partnerFilter ? 'text-cyan-600 dark:text-cyan-400 font-medium bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-700 dark:text-slate-300'}`, children: "All Partners" }), filteredPartners.map((partner) => (_jsx("button", { onClick: () => { setPartnerFilter(partner.id); setPartnerSearch(''); setShowPartnerDropdown(false); }, className: `w-full text-left px-3 py-2.5 text-xs sm:text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors ${partnerFilter === partner.id ? 'text-cyan-600 dark:text-cyan-400 font-medium bg-cyan-50 dark:bg-cyan-900/20' : 'text-slate-700 dark:text-slate-300'}`, children: partner.name }, partner.id))), filteredPartners.length === 0 && (_jsx("p", { className: "px-3 py-2.5 text-xs text-slate-400", children: "No partners found" }))] })] }))] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "UTM Source" }), _jsxs("select", { value: utmSourceFilter, onChange: (e) => setUtmSourceFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "Select" }), utmSources.map((source) => (_jsx("option", { value: source, children: source }, source)))] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Vehicle Type" }), _jsxs("select", { value: vehicleTypeFilter, onChange: (e) => setVehicleTypeFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "Select" }), vehicleTypes.map((type) => (_jsx("option", { value: type, children: type }, type)))] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs sm:text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "User Type" }), _jsxs("select", { value: userTypeFilter, onChange: (e) => setUserTypeFilter(e.target.value), className: "w-full pl-3 pr-9 py-2 bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-lg text-xs sm:text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%27%23475569%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%27%3e%3c/polyline%3e%3c/svg%3e')] bg-[length:1.25rem] bg-[right_0.5rem_center] bg-no-repeat", children: [_jsx("option", { value: "", children: "Select" }), userTypes.map((type) => (_jsx("option", { value: type, children: type }, type)))] })] })] }), _jsx("div", { className: "mt-4 flex justify-end", children: _jsx("button", { onClick: clearFilters, className: "text-xs sm:text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200", children: "Clear all filters" }) })] }))] }), _jsxs("div", { className: "bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden", children: [_jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full", children: [_jsx("thead", { children: _jsxs("tr", { className: "border-b border-slate-200 dark:border-slate-700", children: [_jsx("th", { className: "text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3", children: "Subscriber" }), _jsx("th", { className: "text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3", children: "POC" }), _jsx("th", { className: "text-right text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3", children: "Subscriptions" }), _jsx("th", { className: "text-right text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3", children: "Vehicles" }), _jsx("th", { className: "text-center text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3", children: "Status" }), _jsx("th", { className: "text-right text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wide px-4 py-3 w-16" })] }) }), _jsx("tbody", { className: "divide-y divide-slate-100 dark:divide-slate-700", children: paginatedSubscribers.map((subscriber) => {
                                                return (_jsxs("tr", { onClick: () => handleViewDetails(subscriber.id), className: "hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors cursor-pointer group", children: [_jsx("td", { className: "px-4 py-4", children: _jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "text-sm font-medium text-slate-900 dark:text-white truncate max-w-[200px]", children: subscriber.subscriberName }), _jsx("p", { className: "text-xs text-slate-500 dark:text-slate-400 mt-0.5", children: subscriber.id })] }) }), _jsxs("td", { className: "px-4 py-4", children: [_jsx("p", { className: "text-sm text-slate-900 dark:text-white", children: subscriber.contactPerson }), _jsx("p", { className: "text-xs text-slate-500 dark:text-slate-400 mt-0.5", children: subscriber.phoneNumber })] }), _jsx("td", { className: "px-4 py-4 text-right", onClick: (e) => e.stopPropagation(), children: (() => {
                                                                const count = subscriptionsBySubscriber.get(subscriber.id)?.length ?? 0;
                                                                if (count === 0) {
                                                                    return _jsx("span", { className: "text-sm text-slate-400", children: "0" });
                                                                }
                                                                return (_jsx("button", { onClick: () => setSubscriptionsModalSubscriberId(subscriber.id), className: "inline-flex items-center justify-center min-w-8 px-2 py-1 rounded-md text-sm font-medium text-cyan-700 dark:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 transition-colors", children: count }));
                                                            })() }), _jsx("td", { className: "px-4 py-4 text-right", children: _jsxs("div", { className: "inline-flex items-center gap-1.5 text-sm text-slate-700 dark:text-slate-300", children: [_jsx(TruckIcon, {}), _jsx("span", { className: "font-medium", children: subscriber.numberOfTrucks })] }) }), _jsx("td", { className: "px-4 py-4 text-center", children: _jsx(StatusBadge, { status: subscriber.status }) }), _jsx("td", { className: "px-4 py-4 text-right", onClick: (e) => e.stopPropagation(), children: _jsx(ActionsMenu, { subscriberId: subscriber.id, onViewDetails: handleViewDetails, onEdit: handleEdit }) })] }, subscriber.id));
                                            ...
                                            : 'Get started by adding your first subscriber' }), searchQuery || activeFilterCount > 0 ? (_jsx("button", { onClick: clearFilters, className: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors", children: "Clear all filters" })) : (_jsxs("button", { onClick: () => setShowAddModal(true), className: "inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-cyan-600 rounded-lg hover:bg-cyan-700 transition-colors", children: [_jsx(PlusIcon, {}), "Add Subscriber"] }))] }))] }), filteredSubscribers.length > 0 && (_jsxs("div", { className: "mt-4 flex items-center justify-between px-1", children: [_jsxs("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: ["Showing ", _jsx("span", { className: "font-semibold text-slate-700 dark:text-slate-300", children: startIndex }), " to ", _jsx("span", { className: "font-semibold text-slate-700 dark:text-slate-300", children: endIndex }), " of ", _jsx("span", { className: "font-semibold text-slate-700 dark:text-slate-300", children: filteredSubscribers.length }), " results"] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx("button", { onClick: () => setCurrentPage((p) => Math.max(1, p - 1)), disabled: currentPage === 1, className: "w-9 h-9 flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-30 disabled:cursor-not-allowed transition-colors", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M15 19l-7-7 7-7" }) }) }), Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (_jsx("button", { onClick: () => setCurrentPage(page), className: `w-9 h-9 flex items-center justify-center rounded-lg text-sm font-medium transition-colors ${currentPage === page
                                            ? 'bg-cyan-600 text-white'
                                            : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800'}`, children: page }, page))), _jsx("button", { onClick: () => setCurrentPage((p) => Math.min(totalPages, p + 1)), disabled: currentPage === totalPages, className: "w-9 h-9 flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-30 disabled:cursor-not-allowed transition-colors", children: _jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 5l7 7-7 7" }) }) })] })] }))] }), showAddModal && (_jsx(AddSubscriberModal, { users: users, partners: partners, subscriberSources: subscriberSources, subscriberTypes: subscriberTypes, subscriberSubTypes: subscriberSubTypes, onSubmit: handleAddSubscriber, onClose: () => setShowAddModal(false) })), showBulkUploadModal && (_jsx(BulkUploadModal, { onUpload: handleBulkUpload, onDownloadTemplate: handleDownloadTemplate, onClose: () => setShowBulkUploadModal(false) })), subscriptionsModalSubscriberId && (() => {
                ...
                if (!subscriber)
                    return null;
                return (_jsx(SubscriptionsListModal, { subscriberName: subscriber.subscriberName, subscriptions: subs, onSelect: (subscriptionId) => {
