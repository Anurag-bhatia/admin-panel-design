...
import { X, CheckCircle, XCircle, MapPin, Filter, ChevronDown, ShieldCheck } from 'lucide-react'
...
export function ValidateResultsView({ results, onClose, onConfirm }: ValidateResultsProps) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                {results.length} {results.length === 1 ? 'challan' : 'challans'} validated •{' '}
