...
import { ArrowLeft, Clock, UserPlus, Scale, MoreHorizontal, Search, } from 'lucide-react';
const TYPE_LABELS = {
    payAndClose: 'PPT',
    contest: 'Bulk',
};
...
export function IncidentDetailHeader({ incident, subscriber, assignedAgent, assignedLawyer, onBack, onScreen, onAssignAgent, onAssignLawyer, onMoveQueue, }) {
