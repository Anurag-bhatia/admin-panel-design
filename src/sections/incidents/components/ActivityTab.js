...
import { Plus, MessageSquare, Clock, X, UserPlus, Scale, FileText, CheckCircle, ArrowRight, Upload, AlertCircle, } from 'lucide-react';
const ACTION_CONFIG = {
    created: {
        icon: Plus,
...
export function ActivityTab({ followUps, activities, onAddFollowUp }) {
