...
function computeDaysLeft(createdAt, isExpress) {
...
export function IncidentRow({ incident, isSelected, users, lawyers, workType = 'challans', onSelect, onView, onScreen, onAssignAgent, onAssignLawyer, onMoveQueue, onAddExpense, onUpdate, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("tr", { className: `border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer ${isSelected ? 'bg-cyan-50 dark:bg-cyan-900/10' : ''}`, onClick: onView, children: [_jsx("td", { className: "px-4 py-3", onClick: (e) => e.stopPropagation(), children: _jsx("input", { type: "checkbox", checked: isSelected, onChange: (e) => onSelect(e.target.checked), className: "h-4 w-4 rounded border-slate-300 dark:border-slate-600 text-cyan-600 focus:ring-cyan-500 dark:bg-slate-800" }) }), _jsx("td", { className: "px-4 py-3", children: _jsxs("div", { children: [incident.isExpress && (_jsx("span", { className: "inline-flex items-center px-1 py-px rounded text-[9px] font-semibold uppercase tracking-wider bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800 mb-1", children: "Express" })), _jsx("span", { className: "block font-mono text-sm font-medium text-slate-900 dark:text-white", children: incident.incidentId }), (() => {
