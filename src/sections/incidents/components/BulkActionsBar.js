...
import { X, Search, UserPlus, Scale, ArrowRight, Upload, ChevronDown, Receipt, } from 'lucide-react';
const QUEUE_OPTIONS = [
...
export function BulkActionsBar({ selectedCount, activeQueue, workType = 'challans', onClearSelection, onScreen, onAssignAgent, onAssignLawyer, onMoveQueue, onAddExpense, onBulkUpdate, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-in slide-in-from-bottom-4 duration-300", children: _jsxs("div", { className: "flex items-center gap-2 px-4 py-3 bg-slate-900 dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-700", children: [_jsxs("div", { className: "flex items-center gap-2 pr-3 border-r border-slate-700", children: [_jsx("span", { className: "flex items-center justify-center min-w-[24px] h-6 px-2 rounded-full bg-cyan-500 text-white text-sm font-semibold", children: selectedCount }), _jsx("span", { className: "text-sm text-slate-300", children: "selected" }), _jsx("button", { onClick: onClearSelection, className: "p-1 hover:bg-slate-700 rounded transition-colors", children: _jsx(X, { className: "h-4 w-4 text-slate-400" }) })] }), _jsx("div", { className: "flex items-center gap-1", children: activeQueue === 'notSettled' ? (_jsxs("button", { onClick: () => onMoveQueue?.('refund'), className: "inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-white hover:bg-slate-700 rounded-lg transition-colors", children: [_jsx(ArrowRight, { className: "h-4 w-4" }), _jsx("span", { children: "Send to Refund" })] })) : (_jsxs(_Fragment, { children: [!isCases && (_jsxs("button", { onClick: () => {
                                            ...
                                            : 'text-white hover:bg-slate-700'}`, children: [_jsx(Search, { className: "h-4 w-4" }), _jsx("span", { children: "Screen" })] })), _jsx("div", { className: "w-px h-6 bg-slate-700 mx-1" }), !isCases && (_jsxs("button", { onClick: () => {
                                            if (!isNewIncidents) {
                                                setShowQueueDropdown(false);
                                                onAssignAgent?.();
                                            }
                                            ...
                                            ? 'text-slate-500 cursor-not-allowed'
                                            : 'text-white hover:bg-slate-700'}`, title: isNewIncidents ? 'Available once moved to In Progress' : undefined, children: [_jsx(UserPlus, { className: "h-4 w-4" }), _jsx("span", { children: "Assign Agent" })] })), _jsxs("button", { onClick: () => {
