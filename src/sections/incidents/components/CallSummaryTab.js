    ...
    return (_jsxs("div", { className: "p-6", children: [_jsx("div", { className: "flex items-center justify-between mb-6", children: _jsxs("div", { children: [_jsx("h2", { className: "text-lg font-semibold text-slate-900 dark:text-white", children: "Call Summary" }), _jsxs("p", { className: "text-sm text-slate-500 dark:text-slate-400", children: [SAMPLE_CALLS.length, " calls recorded for this incident"] })] }) }), _jsx("div", { className: "space-y-4", children: SAMPLE_CALLS.map((call) => {
                    ...
                    return (_jsxs("div", { className: "bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden", children: [_jsxs("button", { onClick: () => toggleExpand(call.id), className: "w-full px-4 py-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: `p-2 rounded-full ${call.direction === 'inbound'
                                                    ...
                                                    : 'bg-blue-100 dark:bg-blue-900/30'}`, children: _jsx(Phone, { className: `h-4 w-4 ${call.direction === 'inbound'
                                                        ...
                                                        : 'text-blue-600 dark:text-blue-400'}` }) }), _jsxs("div", { className: "text-left", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "font-medium text-slate-900 dark:text-white", children: call.callerName }), _jsx("span", { className: "text-xs px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-400", children: call.callerRole })] }), _jsxs("div", { className: "flex items-center gap-3 mt-1 text-xs text-slate-500 dark:text-slate-400", children: [_jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Calendar, { className: "h-3 w-3" }), formatDate(call.timestamp)] }), _jsx("span", { children: formatTime(call.timestamp) }), _jsxs("span", { className: "flex items-center gap-1", children: [_jsx(Clock, { className: "h-3 w-3" }), call.duration] }), _jsx("span", { className: `px-1.5 py-0.5 rounded text-xs ${call.direction === 'inbound'
                                                                    ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400'
                                                                    : 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400'}`, children: call.direction === 'inbound' ? 'Incoming' : 'Outgoing' })] })] })] }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("span", { className: `px-2 py-1 rounded-full text-xs font-medium ${call.sentiment === 'positive'
                                                    ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400'
                                                    : call.sentiment === 'negative'
                                                        ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400'
                                                        : 'bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300'}`, children: call.sentiment.charAt(0).toUpperCase() + call.sentiment.slice(1) }), isExpanded ? (_jsx(ChevronUp, { className: "h-5 w-5 text-slate-400" })) : (_jsx(ChevronDown, { className: "h-5 w-5 text-slate-400" }))] })] }), isExpanded && (_jsx("div", { className: "px-4 pb-4 border-t border-slate-200 dark:border-slate-700", children: _jsxs("div", { className: "pt-4 space-y-4", children: [_jsxs("div", { children: [_jsx("h4", { className: "text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Summary" }), _jsx("p", { className: "text-sm text-slate-600 dark:text-slate-400", children: call.summary })] }), _jsxs("div", { children: [_jsx("h4", { className: "text-sm font-medium text-slate-700 dark:text-slate-300 mb-2", children: "Key Points" }), _jsx("ul", { className: "space-y-1.5", children: call.keyPoints.map((point, index) => (_jsxs("li", { className: "flex items-start gap-2 text-sm text-slate-600 dark:text-slate-400", children: [_jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-cyan-500 mt-1.5 flex-shrink-0" }), point] }, index))) })] }), call.nextSteps && (_jsxs("div", { className: "bg-amber-50 dark:bg-amber-900/20 rounded-lg p-3", children: [_jsx("h4", { className: "text-sm font-medium text-amber-800 dark:text-amber-400 mb-1", children: "Next Steps" }), _jsx("p", { className: "text-sm text-amber-700 dark:text-amber-300", children: call.nextSteps })] })), _jsxs("div", { className: "flex items-center gap-3 pt-2", children: [_jsxs("button", { className: "inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-cyan-600 dark:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 rounded-lg transition-colors", children: [_jsx(Play, { className: "h-4 w-4" }), "Play Recording"] }), _jsx("span", { className: "text-xs text-slate-400", children: call.phoneNumber })] })] }) }))] }, call.id));
                }) })] }));
}
